...
//Study Case: Tentukan Algoritma, Pseudocode, dan Codingan dari Luas Permukaan Tabung

/*
Algoritma
1. Tentukan rumus luasPermukaanTabung: ((2 * pi * r) * t) + (2 * (pi * r * r))
2. Buat variabel tinggi
3. Buat variabel pi
4. Buat variabel r
5. Buat variabel luasPermukaanTabung
6. Isi luasPermukaanTabung dengan rumus ((2 MUL pi MUL r) MUL t) ADD (2 MUL (pi MUL r MUL r))
7. Cetak luasPermukaanTabung

Pseudocode
STORE t WITH number
STORE pi WITH 3.14
STORE r WITH number
STORE luasPermukaanTabung WITH ((2 MUL pi MUL r) MUL t) ADD (2 MUL (pi MUL r MUL r))
